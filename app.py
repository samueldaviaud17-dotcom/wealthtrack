...
def _compute_tri_global_et_benchmarks():
    ...
    _hist_raw = gh_read("historique_dca.json")
    _hist = _hist_raw if isinstance(_hist_raw, dict) else (json.loads(_hist_raw) if _hist_raw else {})
    ...
    # Année en cours (2026) depuis le Sheet Bourse/Crypto
    _YR_NOW = _now.year
