...
with tab4:
    ...
    with _cr_col1:
        ...
        st.markdown(card("CAPITAL RÉEL", f"{_cr_val:.2f} €",
                         "← modifiable", C['teal'], "🏦"), unsafe_allow_html=True)
        with st.popover("✏️", use_container_width=False):
            st.markdown(f"**Capital réel actuel :** {_cr_val:.2f} €")
            _new_cr = st.number_input("Nouvelle valeur (€)", value=float(_cr_val),
