...
seront reconstruits depuis le JSON — le Snapshot figera le point de fin de mois pour chaque courbe.""",
    ...
    _chantier_card("Tableau Portefeuille Crypto depuis JSON", "₿",
        """Le tableau Portefeuille Crypto (Bitcoin/Solana/Ethereum/BinanceCoin/USDC avec
Investi $, PRU, PV/MV) lit encore le Google Sheet. Maintenant que crypto_positions.json
contient investi_usd ET investi_eur par token (30/06/2026), ce tableau peut être reconstruit
nativement depuis le JSON — fait partie du Chantier 8.""",
        C['muted'])
