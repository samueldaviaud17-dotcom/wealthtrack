...
<th style='text-align:right;padding:4px'>Total</th></tr></thead><tbody>"""
    ...
    with st.expander("✏️ Modifier / Supprimer un versement", expanded=False):
        _edit_type = st.radio("Enveloppe", ["Bourse", "Crypto"], horizontal=True, key="edit_type")
...
seront reconstruits depuis le JSON — le Snapshot figera le point de fin de mois pour chaque courbe.""",
    ...
    _chantier_card("Suppression d'une conversion crypto", "🔄",
        """Le bloc "🔄 Conversion entre cryptos" (30/06/2026) ne permet pas encore d'annuler une
conversion déjà enregistrée — contrairement aux versements, pas de bouton supprimer dans
l'historique des conversions. À ajouter dans l'onglet Modifier/Supprimer si besoin.""",
        C['muted'])
