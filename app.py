...
<div style="font-size:10px;color:{C['muted']}">{score_detail}</div>
        ...
        add_wl_clicked = st.session_state.get("valo_add_clicked", False)
        if add_wl_clicked: st.session_state["valo_add_clicked"] = False
        if (add_wl or add_wl_clicked) and action_name and cours_v > 0:
