...
(cron externe hors scope). À faire après stabilisation visuelle de tous les onglets.""",
    ...
    _chantier_card("5 — Historique TRI dans le temps", "📈",
        """Snapshot mensuel du TRI Global stocké sur GitHub. Graphique d'évolution trimestriel/
semestriel pour voir la tendance. Nécessite le backup JSON (chantier 1 ✅).""",
        C['cyan'])
