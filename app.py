...
<b>✅ Fait</b> : Calendrier Earnings (yf.Ticker.calendar + earnings_dates) pour les tickers détenus (IBKR options ouvertes + actions) + watchlist. Regroupement par semaine, badge "CETTE SEMAINE", délai coloré, EPS/Rev estimés.<br>
<b>🔄 Reste</b> : Affinage visuel du calendrier Earnings (mise en page, couleurs, layout) + robustesse source données yfinance.""",
            "#EAB308")
