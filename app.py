...
<div style="width:40px;height:40px;border-radius:10px;background:linear-gradient(135deg,#0D1B2A,#1a1a2e);
border:1px solid #1F6FEB44;display:flex;align-items:center;justify-content:center;overflow:hidden;flex-shrink:0">
<svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Graphe barre stylisé -->
  <rect x="3"  y="18" width="4" height="9"  rx="1.5" fill="url(#g2)" opacity="0.7"/>
  <rect x="9"  y="12" width="4" height="15" rx="1.5" fill="url(#g1)" opacity="0.85"/>
  <rect x="15" y="7"  width="4" height="20" rx="1.5" fill="url(#g1)"/>
  <rect x="21" y="10" width="4" height="17" rx="1.5" fill="url(#g2)" opacity="0.9"/>
  <!-- Ligne de tendance -->
  <polyline points="5,17 11,11 17,6 23,9" stroke="#7DD3FC" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round" opacity="0.9"/>
  <!-- Point terminal -->
  <circle cx="23" cy="9" r="2" fill="#7DD3FC"/>
</svg>
</div>
