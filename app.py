...
with tab5:
    ...
    with Lp:
        ...
        st.markdown(f"<div style='font-size:10px;color:{C['muted']};padding:2px 0 0 0;margin-top:0;font-style:italic'>"
    ...
    with Rp:
        ...
        st.markdown(f"""<div style="margin-top:4px;padding:6px 10px;background:{C['card']};
