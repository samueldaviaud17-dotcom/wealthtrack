...
with tab5:
    ...
    for col,(ti,va,su,co,ic) in zip([c1,c2,c3],[
    ...
    with Rp:
        st.markdown(card("TRI ANNUALISÉ", pct(_tri_g) if _tri_g is not None else "—", "global, XIRR", C['purple'], "⚡"), unsafe_allow_html=True)
        with st.popover("ⓘ aide", use_container_width=True):
