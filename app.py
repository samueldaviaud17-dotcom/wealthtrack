...
tab1, tab5, tab2, tab3, tab4, tab8, tab6, tab7, tab_marche, tab9 = st.tabs(["🏠 Vue d'ensemble", "📊 Performance", "📈 Bourse", "₿ Crypto", "⚙️ Options", "📊 IBKR Analyse", "🔍 Valorisation", "⭐ Watchlist", "🌍 Contexte Marché", "🚧 Chantier"])
...
.mkt-card-chart svg { width: 100% !important; height: 100% !important; display: block; }
  ...
  <div style="padding:0 14px 10px 14px;display:flex;justify-content:space-between;align-items:center">
    ...
    # ── Calendrier Earnings (à venir) ──
    st.markdown("<div style='margin-top:16px'></div>", unsafe_allow_html=True)
    sec("Calendrier Earnings", "📅", "#818CF8", "#0D0F1A")
    st.info("📅 Calendrier des earnings à venir — Chantier 3 (en cours)", icon=None)
...
GITHUB_REPO, GITHUB_BRANCH.""", "#6EE7B7")
    ...
    with st.expander("🔄 3 — Contexte Marché (partiellement terminé)", expanded=False):
...
<b>🔄 Reste</b> : Calendrier Earnings (yf.Ticker.calendar) pour les tickers détenus + watchlist.""",
            "#6EE7B7")
