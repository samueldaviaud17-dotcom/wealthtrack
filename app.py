...
<b>🔄 Reste</b> : Les graphes, KPIs et tableaux de l'app lisent encore de nombreuses valeurs depuis le Google Sheet (sv(df_pf,...), sv(df_b,...), etc.). Ce travail de coupure est couvert par le <b>Chantier 7</b> — Autonomie totale vs Google Sheet.""",
        "#6EE7B7", "En cours")
