...
with tab8:
  ...
  {_best_html}
  <div style='margin-top:14px;border-top:1px solid #21262D;padding-top:10px;display:flex;justify-content:space-between'>
    <span style='font-size:11px;color:#8B949E'>Généré par SamInvest</span>
    <span style='font-size:11px;color:#8B949E'>{_now_an.strftime('%d/%m/%Y')}</span>
  </div>
</div>"""
        ...
        # Bouton export image
        st.markdown("""<div style='margin-top:10px;text-align:right'>
<button id='btn-export' onclick='exportRapport()' style='background:#21262D;color:#E6EDF3;border:1px solid #30363D;border-radius:8px;padding:8px 18px;font-size:12px;cursor:pointer;font-weight:600'>
📸 Télécharger le rapport en image</button></div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js"></script>
<script>
function exportRapport(){
  var el=document.getElementById('rapport-mois');
  if(!el){alert('Rapport non trouvé');return;}
  html2canvas(el,{backgroundColor:'#0D1117',scale:2}).then(function(canvas){
    var a=document.createElement('a');
    a.download='rapport_options.png';
