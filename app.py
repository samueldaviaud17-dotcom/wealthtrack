...
with tab3:
    ...
    for _tk in _C3_ORDER:
        ...
        _inv_eur   = _inv_usd / _c3_fx if _c3_fx else 0.0
        _pvmv_eur  = _val_eur - _inv_eur
        _perf_pct  = (_pvmv_eur / _inv_eur * 100) if _inv_eur else 0.0
        ...
        _c3_rows.append({
            ...
            "inv_usd": _inv_usd, "inv_eur": _inv_eur,
            "prix": _prix, "pru_usd": _pru_usd,
            "val_usd": _val_usd, "val_eur": _val_eur,
            "pvmv_eur": _pvmv_eur, "perf_pct": _perf_pct,
    ...
    _c3_tot_inv_eur = sum(r["inv_eur"] for r in _c3_rows)
    _c3_tot_pvmv    = sum(r["pvmv_eur"] for r in _c3_rows)
    ...
    with L3:
        ...
        for r in _c3_rows:
            _pc = C['green'] if r['pvmv_eur'] >= 0 else C['red']
            ...
            _tbl_c += (f"<tr style='border-bottom:1px solid #1F2937'>"
                ...
                f"<td style='padding:6px 10px;text-align:right;color:{_pc};font-weight:600'>{'+' if r['pvmv_eur']>=0 else ''}{r['pvmv_eur']:,.2f} €</td>"
                f"<td style='padding:6px 10px;text-align:right;color:{_pc};font-weight:600'>{'+' if r['perf_pct']>=0 else ''}{r['perf_pct']:.1f} %</td>"
                "</tr>")
