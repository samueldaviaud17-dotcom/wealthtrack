...
<div>
  ...
  <div style='font-size:11px;color:{C['teal']}'>✏️ cliquer pour modifier</div>
</div>
</div>""", unsafe_allow_html=True)
...
\n**Différence avec le ROI Total (haut)** : le ROI Total est toujours sur toutes les années et divisé par le Capital Réel (valeur actuelle du compte).""")
        ...
        if opts_open:
            ...
            tbl_o = f"<div style='overflow-x:auto'><table style='width:100%;border-collapse:collapse;font-size:13px'>"
