...
<tbody>'''
  ...
  <td style="padding:7px 12px;text-align:right;font-weight:700;color:{'#3FB950' if pru_w > 0 and cours_w <= pru_w else ('#F85149' if pru_w > 0 and cours_w > pru_w else C["text"])}">{cours_w:,.2f} €</td>
