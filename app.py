...
with tab3:
    ...
    # ── KPIs ──
    _c3_pvmv_net = _c3_tot_pvmv - _c3_frais_total
    _c3_perf_net = (_c3_pvmv_net / _c3_tot_inv_eur * 100) if _c3_tot_inv_eur else 0.0
    cols = st.columns(5)
    for col, (ti, va, su, co, ic) in zip(cols, [
        ("VALEUR PF (€)", fmt(_c3_tot_val_eur),                          "",                              C['gold'],  "💶"),
        ("VALEUR PF ($)", f"{_c3_tot_val_usd:.2f} $",                    "",                              C['gold'],  "💵"),
        ("TOTAL INVESTI", fmt(_c3_tot_inv_eur),                           "",                              C['blue'],  "💰"),
        ("PV / MV NET",   fmt(_c3_pvmv_net),                             f"{pct(_c3_perf_net)} · frais déduits ({_c3_frais_total:.0f}€)", pcol(_c3_perf_net), "📈"),
        ("FRAIS CUMULÉS", f"-{_c3_frais_total:.2f} €",                   "depuis 2022",                   C['red'],   "💸"),
    ]):
