...
<div style="position:relative;width:calc(100% + 4rem);margin-left:-2rem;height:80px;overflow:hidden;margin-bottom:12px">
<img src="data:image/png;base64,{_BNR}" style="width:100%;height:100%;object-fit:cover;object-position:center 30%;display:block"/>
<div style="position:absolute;top:0;left:0;height:100%;width:35%;background:linear-gradient(to right,rgba(10,14,23,0.95) 50%,transparent)"></div>
<div style="position:absolute;top:0;right:0;height:100%;width:50%;background:linear-gradient(to left,rgba(10,14,23,0.92) 50%,transparent)"></div>
<div style="position:absolute;left:16px;top:50%;transform:translateY(-50%);display:flex;align-items:center;gap:10px">
<img src="data:image/png;base64,{LOGO_B64}" style="width:36px;height:36px;object-fit:cover;border-radius:8px"/>
<span style="font-family:Space Grotesk,sans-serif;font-size:20px;font-weight:700;color:#e6edf3">SamInvest</span>
</div>
<div style="position:absolute;right:140px;top:50%;transform:translateY(-50%);display:flex;align-items:center;gap:12px">
