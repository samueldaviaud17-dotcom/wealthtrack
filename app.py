...
\n**Différence avec le ROI Total (haut)** : le ROI Total est toujours sur toutes les années et divisé par le Capital Réel (valeur actuelle du compte).""")
        ...
        if opts_open:
            ...
            tbl_o += _THL("Symbole","13%") + _THL("Ticker","5%") + _THL("Type","7%") + _THC("Qté","3%") + _THL("C/P","3%") + _THL("Strike","5%") + _THC("Prix Live","5%") + _THL("Ouverture","6%") + _THL("Expiration","6%") + _THC("J. restants","5%") + _THC("Marge","7%") + _TH("Frais","6%") + _TH("Prime enc.","8%")
