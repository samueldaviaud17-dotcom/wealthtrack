...
Performance) affiche la courbe cumulée + le point live du jour. 100% app — zéro lien Sheet.<br><br>
<b>Extension prévue après chantier 7 (autonomie totale)</b> : étendre la logique snapshot à
<b>tous les graphiques annuels et mensuels</b> actuellement alimentés par Google Sheet
(Évolution annuelle du patrimoine, Évolution mensuelle, etc.). Une fois les données saisies
en dur dans l'app (chantier 7b/7c), ces graphiques seront reconstruits depuis le JSON —
le bouton Snapshot servira alors à figer le point de fin de mois pour chaque courbe.""",
            "#6EE7B7")
