...
tab1, tab5, tab_marche, tab2, tab3, tab4, tab8, tab6, tab7, tab_saisie, tab9 = st.tabs(["🏠 Vue d'ensemble", "📊 Performance", "🌍 Contexte Marché", "📈 Bourse", "₿ Crypto", "⚙️ Options", "📊 IBKR Analyse", "🔍 Valorisation", "⭐ Watchlist", "✏️ Saisie DCA", "🚧 Chantier"])
...
with tab5:
    ...
    with Rp:
        ...
        _fn2 = f'<div style="font-size:10px;color:{C["muted"]};padding:1px 2px 0 2px;margin-top:-2px;font-style:italic">TRI (XIRR) : Bourse/Crypto = DCA le 4 de chaque mois depuis févr. 2022 / août 2022, Options = dépôts IBKR réels. Benchmarks simulés avec les mêmes flux (SP500 TR, CAC40 GR, STOXX 600). Alpha = TRI Mon PF − TRI Indice (pts %).</div>'
...
<thead><tr style='color:{C["muted"]}'><th style='text-align:left;padding:4px'>Date</th>
