...
with tab5:
    ...
    with Lp:
        ...
        _fn1 = f"<div style='font-size:10px;color:{C['muted']};padding:3px 2px 0 2px;font-style:italic'>TRI (XIRR) calculé sur les versements réels : Bourse/Crypto = DCA le 4 de chaque mois depuis févr. 2022 / août 2022, Options = dépôts IBKR réels depuis déc. 2023.</div>"
    ...
    with Rp:
        ...
        _fn2 = f'<div style="font-size:10px;color:{C["muted"]};padding:3px 2px 0 2px;font-style:italic">TRI (XIRR) : Bourse/Crypto = DCA le 4 de chaque mois depuis févr. 2022 / août 2022, Options = dépôts IBKR réels. Benchmarks simulés avec les mêmes flux (SP500 TR, CAC40 GR, STOXX 600). Alpha = TRI Mon PF − TRI Indice (pts %).</div>'
...
<b>✅ Fait</b> : Robustesse yfinance — messages explicites si données indisponibles sur toutes les cards (indices, VIX) et calendriers (Earnings, Dividendes). Try/except partout, pas d'erreur silencieuse.""",
    ...
    with st.expander("🔄 3b — Chantier Visuel Intermédiaire (en cours)", expanded=True):
        _chantier_card("Ajustements visuels Performance", "🎨",
            """Corrections d'espacement sur l'onglet Performance.<br>
<b>✅ Fait</b> : Réduction de l'espace entre les KPIs du haut et les tableaux Performance/TRI.<br>
<b>✅ Fait</b> : Footnote "TRI calculé sur les versements réels..." collé directement sous son tableau Performance.<br>
<b>✅ Fait</b> : Footnote "TRI vs Benchmarks..." collé directement sous son tableau TRI.""",
            "#818CF8")
