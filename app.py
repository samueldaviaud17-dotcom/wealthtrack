    ...
    padding-bottom: 0 !important;
        ...
        with st.expander("📊 Indices de référence — variation journalière", expanded=True):
            ...
            <div style="font-size:13px;color:{C['muted']};margin-top:4px">—</div></div>""", unsafe_allow_html=True)
                    ...
                    _SW, _SH = 300, 160
                    # Forcer le range à inclure 0 pour que la ligne soit correcte
                    ...
                    # Ligne de 0 = position exacte de 0 dans le range
                    ...
                    st.markdown(
                        f'<div style="background:{C["card"]};border:1px solid {C["border"]};'
                        f'border-radius:8px;overflow:hidden;height:250px;display:flex;flex-direction:column">'
