        ...
        <div style="font-size:13px;color:{C['muted']};margin-top:4px">—</div></div>""", unsafe_allow_html=True)
            ...
            <div style="font-size:13px;color:{C['muted']};margin-top:4px">—</div></div>""", unsafe_allow_html=True)
                    ...
                    for _v, _lbl in [(0,'0'),(25,'25'),(50,'50'),(75,'75'),(100,'100')]:
                        ...
                        if _v == 0:
                            _t_anchor = 'start'
                            _tlx, _tly = _tx2 + 4, _ty2 - 16
                        elif _v == 100:
                            _t_anchor = 'end'
                            _tlx, _tly = _tx2 - 4, _ty2 - 16
                        _ticks_svg += f'<line x1="{_tx1:.1f}" y1="{_ty1:.1f}" x2="{_tx2:.1f}" y2="{_ty2:.1f}" stroke="#888" stroke-width="1.5"/>'
                        _ticks_svg += f'<text x="{_tlx:.1f}" y="{_tly:.1f}" text-anchor="{_t_anchor}" dominant-baseline="middle" font-size="11" font-weight="600" fill="#AAAAAA">{_lbl}</text>'
